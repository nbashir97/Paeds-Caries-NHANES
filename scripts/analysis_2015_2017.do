...
use "{User directory}\NHANES_2015.dta", clear
use "{User directory}\NHANES_2017.dta", clear
...
forvalues i = 02/31 {
	...
	foreach var of varlist ohx`I'ctc {
			generate ohx`I'prim_d = 1 if(`var' == "K")
			recode ohx`I'prim_d(. = 0)
	}
}
...
forvalues i = 02/31 {
	...
	local I : di %02.0f `i'
	foreach var of varlist ohx`I'ctc {
			generate ohx`I'perm_d = 1 if(`var' == "Z")
			recode ohx`I'perm_d(. = 0)
	}
}
...
forvalues i = 02/31 {
	...
	local I : di %02.0f `i'
	foreach var of varlist ohx`I'ctc {
			generate ohx`I'prim_f = 1 if(`var' == "A")
			recode ohx`I'prim_f(. = 0)
	}
}
...
forvalues i = 02/31 {
	...
	local I : di %02.0f `i'
	foreach var of varlist ohx`I'ctc {
			generate ohx`I'perm_f = 1 if(`var' == "F")
			recode ohx`I'perm_f(. = 0)
	}
}
